...
public class TileEntityRedChestRenderer extends TileEntitySpecialRenderer
{
     ...
     */
    public void renderTileEntityChestAt(TileEntityRedChest par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int var9;
        ...
        if (par1TileEntityChest.adjacentChestZNeg == null && par1TileEntityChest.adjacentChestXNeg == null)
        {
            ...
            if (par1TileEntityChest.adjacentChestXPos == null && par1TileEntityChest.adjacentChestZPosition == null)
            {
                ...
                this.bindTextureByName("/morered/chest.png");
            }
            else
            {
                var14 = this.largeChestModel;
                this.bindTextureByName("/morered/largechest.png");
            }
    ...
    {
        this.renderTileEntityChestAt((TileEntityRedChest)par1TileEntity, par2, par4, par6, par8);
    }
}